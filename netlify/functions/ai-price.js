...
Return ONLY valid JSON, no markdown:
{
  ...
  "message": "One short friendly sentence max 12 words" or null
}

Only return a message if budget seems notably off. If budget not set, return status "unknown" with no message.`
        }]
      })
    });
