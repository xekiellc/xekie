...
exports.handler = async (event) => {
  ...
  const { title, description, location, category, id } = xekie;
...
<table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
  <tr><td style="background:#0a0a0a;border-radius:16px 16px 0 0;padding:32px 40px;">
    <div style="font-size:28px;font-weight:900;letter-spacing:-1px;">
      <span style="color:#ff4d1c;">XE</span><span style="color:#fafaf8;">KIE</span>
    </div>
        ...
        <tr>
          <td style="width:50%;padding-right:8px;">
            <div style="background:white;border-radius:10px;padding:14px 16px;">
              <div style="font-size:10px;font-weight:700;letter-spacing:2px;color:#6b6b6b;text-transform:uppercase;margin-bottom:4px;">Budget</div>
              <div style="font-size:20px;font-weight:900;color:#ff4d1c;">${budgetStr}</div>
            </div>
          </td>
          <td style="width:50%;padding-left:8px;">
            <div style="background:white;border-radius:10px;padding:14px 16px;">
              <div style="font-size:10px;font-weight:700;letter-spacing:2px;color:#6b6b6b;text-transform:uppercase;margin-bottom:4px;">Location</div>
              <div style="font-size:20px;font-weight:900;color:#0a0a0a;">${location || 'Not specified'}</div>
            </div>
          </td>
        </tr>
      </table>
  ...
  <tr><td style="background:#0a0a0a;border-radius:0 0 16px 16px;padding:28px 40px;">
    ...
    <a href="https://xekie.com/notifications.html" style="font-size:12px;color:#666;">Manage your alerts</a>
